//http://www.dailyfreecode.com/Code/deapth-first-search-traversal-dfs-1024.aspx
#include <iostream>
#include <conio.h>
#define MAX_NODE 50
...
void DFS_traversal(){
    ...
    while(is_stk_empty()!=1){
        ...
        //process N and change the status of N to//be processed state.
        N = pop(); //pop the node from stack.
        status[N]=processed; //status of N to processed.
        cout<<"   "<<N; //displaying processed node.
        //step 5 : push onto stack all the neighbours of N,//that are in ready state and change their status to
        //wait state.
